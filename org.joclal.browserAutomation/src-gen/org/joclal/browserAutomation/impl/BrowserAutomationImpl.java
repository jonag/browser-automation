 ...
 * <ul>
 *   <li>{@link org.joclal.browserAutomation.impl.BrowserAutomationImpl#getSubroutines <em>Subroutines</em>}</li>
 *   <li>{@link org.joclal.browserAutomation.impl.BrowserAutomationImpl#getBrowser <em>Browser</em>}</li>
 *   <li>{@link org.joclal.browserAutomation.impl.BrowserAutomationImpl#getFirstGoTo <em>First Go To</em>}</li>
 *   <li>{@link org.joclal.browserAutomation.impl.BrowserAutomationImpl#getActions <em>Actions</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class BrowserAutomationImpl extends MinimalEObjectImpl.Container implements BrowserAutomation
{
  ...
  public EList<Subroutine> getSubroutines()
  {
    if (subroutines == null)
    {
      subroutines = new EObjectContainmentEList<Subroutine>(Subroutine.class, this, BrowserAutomationPackage.BROWSER_AUTOMATION__SUBROUTINES);
    }
    return subroutines;
  }
  ...
  public void setBrowser(Browser newBrowser)
  {
    ...
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, BrowserAutomationPackage.BROWSER_AUTOMATION__BROWSER, oldBrowser, browser));
  }
  ...
  public NotificationChain basicSetFirstGoTo(Goto newFirstGoTo, NotificationChain msgs)
  {
    ...
    if (eNotificationRequired())
    {
      ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, BrowserAutomationPackage.BROWSER_AUTOMATION__FIRST_GO_TO, oldFirstGoTo, newFirstGoTo);
  ...
  public void setFirstGoTo(Goto newFirstGoTo)
  {
    if (newFirstGoTo != firstGoTo)
    {
      ...
      if (firstGoTo != null)
        msgs = ((InternalEObject)firstGoTo).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - BrowserAutomationPackage.BROWSER_AUTOMATION__FIRST_GO_TO, null, msgs);
      if (newFirstGoTo != null)
        msgs = ((InternalEObject)newFirstGoTo).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - BrowserAutomationPackage.BROWSER_AUTOMATION__FIRST_GO_TO, null, msgs);
      msgs = basicSetFirstGoTo(newFirstGoTo, msgs);
      if (msgs != null) msgs.dispatch();
    }
    else if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, BrowserAutomationPackage.BROWSER_AUTOMATION__FIRST_GO_TO, newFirstGoTo, newFirstGoTo));
  }
  ...
  public EList<Action> getActions()
  {
    if (actions == null)
    {
      actions = new EObjectContainmentEList<Action>(Action.class, this, BrowserAutomationPackage.BROWSER_AUTOMATION__ACTIONS);
    }
    return actions;
  }
