...
public class SubroutineImpl extends MinimalEObjectImpl.Container implements Subroutine
{
   ...
   * @ordered
   */
  protected EList<VariableId> params;
   ...
   * @generated
   */
  public EList<VariableId> getParams()
  {
    if (params == null)
    {
      params = new EObjectContainmentEList<VariableId>(VariableId.class, this, BrowserAutomationPackage.SUBROUTINE__PARAMS);
    }
    return params;
  }
  ...
  public void eSet(int featureID, Object newValue)
  {
    switch (featureID)
    {
      ...
      case BrowserAutomationPackage.SUBROUTINE__PARAMS:
        getParams().clear();
        getParams().addAll((Collection<? extends VariableId>)newValue);
        return;
      case BrowserAutomationPackage.SUBROUTINE__ACTIONS:
        getActions().clear();
