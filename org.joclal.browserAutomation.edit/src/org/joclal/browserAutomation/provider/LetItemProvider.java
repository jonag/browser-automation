...
public class LetItemProvider extends ActionItemProvider {
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Let_name_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Let_name_feature", "_UI_Let_type"),
	...
	public String getText(Object object) {
		String label = ((Let)object).getName();
		return label == null || label.length() == 0 ?
			getString("_UI_Let_type") :
			getString("_UI_Let_type") + " " + label;
	}
