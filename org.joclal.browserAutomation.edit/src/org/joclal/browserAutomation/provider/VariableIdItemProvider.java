...
/**
 * This is the item provider adapter for a {@link org.joclal.browserAutomation.VariableId} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class VariableIdItemProvider 
	extends SubroutineParamItemProvider {
	/**
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_VariableId_name_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_VariableId_name_feature", "_UI_VariableId_type"),
				 BrowserAutomationPackage.Literals.VARIABLE_ID__NAME,
				 true,
				 false,
				 false,
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(BrowserAutomationPackage.Literals.VARIABLE_ID__NEXT);
			childrenFeatures.add(BrowserAutomationPackage.Literals.VARIABLE_ID__VALUE);
		}
	...
	public String getText(Object object) {
		String label = ((VariableId)object).getName();
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add
			(createChildParameter
				(BrowserAutomationPackage.Literals.VARIABLE_ID__NEXT,
		...
		newChildDescriptors.add
			(createChildParameter
				(BrowserAutomationPackage.Literals.VARIABLE_ID__VALUE,
