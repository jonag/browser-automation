package org.joclal.browserautomation.interpreter.actions;
...
import org.joclal.browserautomation.interpreter.Interpreter;
...
public class InterpreterAction implements IWorkbenchWindowActionDelegate {
	...
	public void run(IAction action) {
    	...
    	EditorPart activeEditor = (EditorPart) window.getActivePage().getActiveEditor(); 
    	...
    	if(eobject instanceof BrowserAutomation){
    		BrowserAutomation bo = (BrowserAutomation) eobject;
